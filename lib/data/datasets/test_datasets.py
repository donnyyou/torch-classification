...
# Test Datasets for Image Classification.
...
class TestDefaultDataset(data.Dataset):
...
class TestListDataset(data.Dataset):
    ...
    def __init__(self, data_dir=None, list_path=None, aug_transform=None, img_transform=None, configer=None):
        super(TestListDataset, self).__init__()
        self.configer = configer
        self.aug_transform=aug_transform
        self.img_transform = img_transform
        self.item_list = self.__read_list(data_dir, list_path)
